...
jobname=Sepv13L
folder=animating_synsin_20220406_bs16_SeperateJoint19
...
--cpus-per-task=32 \
python train_animating_2layers_joint_finetuneBGFluid_MSE.py --batch-size 16 --folder $folder --num_workers 16  \
        ...
        --log-dir "logging/animating/%s/" --W 256 --ATVloss 1.0  --AKLloss 0.0 --ADCloss 1.0 --AlphaMSEloss 1000.0 --balanced_weight 1 --AlphaWeightDecay 20 --use_reweight_mask_loss \
        ...
        --train_bg --train_alpha --MVloss 1.0   --niter 2 --niter_decay 20 --RockRegionlosstarget 0.25
