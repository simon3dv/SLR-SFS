...
jobname=BG1
folder=animating_synsin_20220406_bs16_BG1
...
python train_animating_BG.py --batch-size 16 --folder $folder --num_workers 16 --model_type "bg" \
        --resume --dataset 'eulerian_data_bg' --use_inverse_depth --accumulation 'wsum' --bg_refine_model_type 'resnet_256W8UpDown64BG_nonorm' --ngf 64 \
