...
jobname=Baseline2
folder=animating_synsin_20220323_bs16_eulerian_pconv_resnetencoder_resnetdecoder_softmax_baseline2
...
python train_animating.py --batch-size 16 --folder $folder --num_workers 32  \
        ...
        --model_type 'softmax_splating' --refine_model_type 'resnet_256W8UpDown64_de_resnet_pconv2_nonorm' --pconv "pconv_pbn_woresbias" \
