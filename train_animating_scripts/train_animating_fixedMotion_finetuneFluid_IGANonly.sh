...
jobname=joint21m19b
folder=animating_synsin_20220511_joint20m19ep200best_lrd2_nodecay_EPE0_hint2
...
python train_animating_fixmotion.py --batch-size 16 --folder $folder --num_workers 16  \
        --resume --dataset 'eulerian_data_hint' --use_inverse_depth --accumulation 'alphacomposite' \
        ...
        --load_motion_regressor --motion_regressor_model "pretrained/motion19_ep200best.pth" \
