...
from models.layers.blocks import ResNet_Block_Pconv
from models.layers.blocks import ResNet_Block_Pconv2
from models.networks.networks import SPADE
...
class SPADEUnet4MaskMotion(nn.Module):
    ...
    def __init__(
        ...
        if "motion_norm_G" in opt:
            motion_norm_G = opt.motion_norm_G.split(":")[1]
