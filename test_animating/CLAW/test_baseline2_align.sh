...
PREDDIR=data/CLAW/results/20220406_N60_W768/eval_baseline2_align/baseline2
PRETRAINEDFILE="pretrained/baseline2_ep100_stage1ofSLRv1.pth"
PYFILE="test_baseline_4eval_rawsize.py"
#ALIGNDATA="None"
