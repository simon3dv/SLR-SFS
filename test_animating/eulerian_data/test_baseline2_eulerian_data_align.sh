...
PREDDIR=/mnt/lustre/fansiming/project/SLR-SFS/data/eulerian_data/results/20220406_N60_W768_align/eval_baseline2/baseline2
PRETRAINEDFILE="pretrained/baseline2_model/model_epoch.pthbest100"
PYFILE="test_baseline_4eval.py"
#ALIGNDATA="None"
ALIGNDATA="data/eulerian_data/align_max_frame_005_max150.json"
